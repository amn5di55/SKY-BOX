...
wget -O box.sh https://raw.githubusercontent.com/amn5di55/SKY-BOX/main/box.sh && chmod +x box.sh && clear && ./box.sh

<pre>wget -O box.sh https://raw.githubusercontent.com/amn5di55XN/SKY-BOX/main/box.sh && chmod +x box.sh && clear && ./box.sh</pre>
